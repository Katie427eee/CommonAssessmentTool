...
def train_all_models():
    X_train, _, y_train, _ = prepare_features_targets()
    models = {
    ...
    for name, model in models.items():
        ...
        save_model(model, os.path.join(MODEL_DIR, name))
...
def load_model(filename="model_rf.pkl"):
    with open(os.path.join(MODEL_DIR, filename), "rb") as model_file:
